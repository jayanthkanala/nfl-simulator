...
average_yards("complete_pass", "BUF", "posteam")
...
flag_yards("Defensive Pass Interference", "pass")
...
def field_goal_percentage(currentPosition, team): #Function calculates field goal percentage based on yardage interval of kick
...
print(fumble_chance("rush_attempt", off = "BUF", deff = "KC"))
...
punt = nfls[nfls["kickoff_attempt"] == 1]
print(punt["kick_distance"])


def punt_simulator(off, currentPosition, puntorkick): #parameter is offense
  ...
  while True: #Check that punt isn't too far
    ...
    if rand_punt < ((100- currentPosition) + 10): #Represents currentPosition + end zone length because punts can land in endzone
      break
  return rand_punt[0]
punt_simulator("BUF", 35, "kickoff_attempt") #Buffalo kickoff from their own 35 yard line
