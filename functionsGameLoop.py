    ...
    while time <= 60:
      ...
      if outcome[0] == "pass_attempt":
        ...
        if pass_result == "complete":
          ...
          yards = random_yards(mean = pass_mean, sd = pass_sd, yards = 100, skewness = 3)
          if yards > 0:
        ...
        time += 0.2
          ...
          yards = random_yards(mean = rush_mean, sd = rush_sd, yards = 100, skewness = 1)
          if yards > 0:
            currentPosition += yards
          else:
            currentPosition -= yards
          ...
          yards = random_yards(mean = sack_mean, sd = sack_sd, yards = 20, skewness = -1.5)
          currentPosition += yards
          firstDownLine += yards
          down += 1
          time += 3
      elif outcome[0] == "penalty":
        yards = weighted_rand_penalty_yds()[0]
        currentPosition -= yards
        firstDownLine += yards
        time += 0.2
      if down == 4:
